...
# 3. มีตัวเลือกงบประมาณ ใช้ Slider ตั้งแต่ 10,000 ถึง 100,000 บาท
budget = st.slider("เลือกงบประมาณ (บาท)", min_value=10000, max_value=100000, value=30000, step=1000)
